...
class TestCell:
    ...
    FIGURE_CELL_NO_ARGS = "<br><img style=\"display: block;margin-left:auto; margin-right: auto;\" src='data:image/png;base64,'><br>"
    FIGURE_CELL_WITH_ARGS = "<br><img style=\"display: block;width:200; height:100;\" src='data:image/png;base64,'><br>"
