...
CLASSIFICATION_DATASET_WITHOUT_MODEL_OUTPUT = CLASSIFICATION_DATASET.drop_columns(ColumnNames.MODEL_OUTPUT_COLUMN_NAME.value)

CLASSIFICATION_DATASET_WITHOUT_MODEL_INPUT = CLASSIFICATION_DATASET.drop_columns(ColumnNames.MODEL_INPUT_COLUMN_NAME.value)

CLASSIFICATION_DATASET_WITHOUT_TARGET_OUTPUT = CLASSIFICATION_DATASET.drop_columns(ColumnNames.TARGET_OUTPUT_COLUMN_NAME.value)
