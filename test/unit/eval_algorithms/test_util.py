...
class TestCasePerformEvaluation(NamedTuple):
...
def test_run_evaluation_no_model_output_column(
    ...
    WHEN the `run_evaluation` util function is called.
...
@patch("fmeval.eval_algorithms.util.get_dataset")
@patch("fmeval.eval_algorithms.util.get_dataset_configs")
def test_run_evaluation_with_model_output_column(
    mock_get_dataset_configs,
    mock_get_dataset,
    mock_validate_dataset,
    mock_standard_invocation_pipeline,
