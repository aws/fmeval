...
CATEGORY_SCORES = [
    CategoryScore(
        ...
        scores=[
            ...
            EvalScore(name=DELTA_PRECISION, value=0.0),
            EvalScore(name=DELTA_RECALL, value=0.0),
        ],
    ),
    CategoryScore(
        name="sports",
        ...
        [
            TestCaseQAAccuracySemanticRobustnessEvaluateSample(
                ...
                expected_response=[
                    ...
                    EvalScore(name=DELTA_PRECISION, value=1.0),
                    EvalScore(name=DELTA_RECALL, value=1.0),
                ],
            ...
            TestCaseQAAccuracySemanticRobustnessEvaluateSample(
                ...
                expected_response=[
                    ...
                    EvalScore(name=EXACT_MATCH_SCORE, value=0.0),
                    EvalScore(name=QUASI_EXACT_MATCH_SCORE, value=1.0),
                    EvalScore(name=PRECISION, value=1),
                    EvalScore(name=RECALL, value=1),
                    EvalScore(name=DELTA_F1_SCORE, value=0.5),
                    EvalScore(name=DELTA_EXACT_MATCH_SCORE, value=0.0),
                    EvalScore(name=DELTA_QUASI_EXACT_MATCH_SCORE, value=0.5),
                    EvalScore(name=DELTA_PRECISION, value=0.5),
                    EvalScore(name=DELTA_RECALL, value=0.5),
                ],
                config=QAAccuracySemanticRobustnessConfig(
            ...
            TestCaseQAAccuracySemanticRobustnessEvaluateSample(
                ...
                expected_response=[
                    ...
                    EvalScore(name=EXACT_MATCH_SCORE, value=0.0),
                    EvalScore(name=QUASI_EXACT_MATCH_SCORE, value=0.0),
                    EvalScore(name=PRECISION, value=1 / 3),
                    EvalScore(name=RECALL, value=1),
                    EvalScore(name=DELTA_F1_SCORE, value=0.5),
                    EvalScore(name=DELTA_EXACT_MATCH_SCORE, value=0.0),
                    EvalScore(name=DELTA_QUASI_EXACT_MATCH_SCORE, value=0.0),
                    EvalScore(name=DELTA_PRECISION, value=1 / 3),
                    EvalScore(name=DELTA_RECALL, value=1.0),
                ],
                config=QAAccuracySemanticRobustnessConfig(
