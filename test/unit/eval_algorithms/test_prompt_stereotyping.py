        ...
        [
            TestCasePromptStereotypingEvaluate(
                input_dataset=ray.data.from_items(
                    [
                        {
                            ColumnNames.SENT_MORE_INPUT_COLUMN_NAME.value: GENDER_MORE_STEREOTYPICAL_STATEMENT,
                            ColumnNames.SENT_LESS_INPUT_COLUMN_NAME.value: GENDER_LESS_STEREOTYPICAL_STATEMENT,
                            ColumnNames.CATEGORY_COLUMN_NAME.value: "gender",
                        },
                        {
                            ColumnNames.SENT_MORE_INPUT_COLUMN_NAME.value: SOCIO_ECONOMIC_MORE_STEREOTYPICAL_STATEMENT,
                            ColumnNames.SENT_LESS_INPUT_COLUMN_NAME.value: SOCIO_ECONOMIC_LESS_STEREOTYPICAL_STATEMENT,
                            ColumnNames.CATEGORY_COLUMN_NAME.value: "socioeconomic",
                        },
                        {
                            ColumnNames.SENT_MORE_INPUT_COLUMN_NAME.value: NATIONALITY_MORE_STEREOTYPICAL_STATEMENT,
                            ColumnNames.SENT_LESS_INPUT_COLUMN_NAME.value: NATIONALITY_LESS_STEREOTYPICAL_STATEMENT,
                            ColumnNames.CATEGORY_COLUMN_NAME.value: "nationality",
                        },
                        {
                            ColumnNames.SENT_MORE_INPUT_COLUMN_NAME.value: SEXUAL_ORIENTIATION_MORE_STEREOTYPICAL_STATEMENT,
                            ColumnNames.SENT_LESS_INPUT_COLUMN_NAME.value: SEXUAL_ORIENTIATION_LESS_STEREOTYPICAL_STATEMENT,
                            ColumnNames.CATEGORY_COLUMN_NAME.value: "sexual-orientation",
                        },
                    ]
                ),
                    ...
                    [
                        {
                            ...
                            ColumnNames.SENT_LESS_INPUT_COLUMN_NAME.value: GENDER_LESS_STEREOTYPICAL_STATEMENT,
                            ColumnNames.CATEGORY_COLUMN_NAME.value: "gender",
                            ColumnNames.SENT_MORE_LOG_PROB_COLUMN_NAME.value: np.log(0.9),
                            ColumnNames.SENT_LESS_LOG_PROB_COLUMN_NAME.value: np.log(0.5),
                        },
                        {
                            ColumnNames.SENT_MORE_INPUT_COLUMN_NAME.value: SOCIO_ECONOMIC_MORE_STEREOTYPICAL_STATEMENT,
                            ColumnNames.SENT_LESS_INPUT_COLUMN_NAME.value: SOCIO_ECONOMIC_LESS_STEREOTYPICAL_STATEMENT,
                            ColumnNames.CATEGORY_COLUMN_NAME.value: "socioeconomic",
                            ColumnNames.SENT_MORE_LOG_PROB_COLUMN_NAME.value: np.log(0.2),
                            ColumnNames.SENT_LESS_LOG_PROB_COLUMN_NAME.value: np.log(0.7),
                        },
                        {
                            ColumnNames.SENT_MORE_INPUT_COLUMN_NAME.value: NATIONALITY_MORE_STEREOTYPICAL_STATEMENT,
                            ColumnNames.SENT_LESS_INPUT_COLUMN_NAME.value: NATIONALITY_LESS_STEREOTYPICAL_STATEMENT,
                            ColumnNames.CATEGORY_COLUMN_NAME.value: "nationality",
                            ColumnNames.SENT_MORE_LOG_PROB_COLUMN_NAME.value: np.log(0.8),
                            ColumnNames.SENT_LESS_LOG_PROB_COLUMN_NAME.value: np.log(0.6),
                        },
                        {
                            ColumnNames.SENT_MORE_INPUT_COLUMN_NAME.value: SEXUAL_ORIENTIATION_MORE_STEREOTYPICAL_STATEMENT,
                            ColumnNames.SENT_LESS_INPUT_COLUMN_NAME.value: SEXUAL_ORIENTIATION_LESS_STEREOTYPICAL_STATEMENT,
                            ColumnNames.CATEGORY_COLUMN_NAME.value: "sexual-orientation",
                            ColumnNames.SENT_MORE_LOG_PROB_COLUMN_NAME.value: np.log(0.1),
                            ColumnNames.SENT_LESS_LOG_PROB_COLUMN_NAME.value: np.log(0.4),
                        },
                    ]
                ),
                expected_response=[
