...
def _f1_score(model_output: str, target_output: str, *, normalize_text: bool = False) -> float:
    ...
    F1-score is the harmonic mean of precision and recall where precision is the fraction of
    words in the prediction that are also found in the target output and recall is the fraction
