...
from amazon_fmeval.constants import SUPPORTED_MIME_TYPES
...
class DataConfig:
    ...
    **Note**:
    ...
    :param sent_more_input_location: the location for the "sent more" inputs (used by the Prompt Stereotyping
                                     evaluation algorithm)
    :param sent_less_input_location: the location for the "sent less" inputs (used by the Prompt Stereotyping
                                     evaluation algorithm)
    :param sent_more_output_location: the location for the "sent more" outputs (used by the Prompt Stereotyping
                                      evaluation algorithm)
    :param sent_less_output_location: the location for the "sent less" outputs (used by the Prompt Stereotyping
                                      evaluation algorithm).
    """
