...
def verify_model_determinism(model: ModelRunner, dataset: Dataset, prompt_column_name: str):
    """
    Raise EvalAlgorithmClientError if model is not deterministic for first NUM_ROWS_DETERMINISTIC rows
